      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-12">
        <SectionReveal>
          ...
          <p className="text-text-secondary mb-10 max-w-xl">
            Open to AI / Edge AI internships, end-of-studies projects (PFE),
            hackathons, research collaborations, and freelance front-end /
            UI-UX work.
          </p>
        </SectionReveal>
        ...
        <SectionReveal delay={0.1}>
          <div className="max-w-lg space-y-3">
            <CopyButton label="Email" text={identity.email} />
            <CopyButton label="Phone" text={identity.phone} />
